...
const ZONES = {
  "rutas-johto-sur":    { name: "Rutas del sur de Johto",  region: "johto", unlock: { region: "johto" } },
  "rutas-johto-centro": { name: "Rutas centrales de Johto", region: "johto", unlock: { region: "johto", medals: 10 } },
  "rutas-johto-costa":  { name: "Rutas de la costa",        region: "johto", unlock: { region: "johto", medals: 12 } },
  "rutas-johto-norte":  { name: "Rutas del norte de Johto", region: "johto", unlock: { region: "johto", medals: 14 } },
  "cueva-union":       { name: "Cueva Unión",      region: "johto", unlock: { region: "johto" } },
  "parque-nacional":   { name: "Parque Nacional",  region: "johto", unlock: { region: "johto", medals: 10 } },
  "pozo-slowpoke":     { name: "Pozo Slowpoke",    region: "johto", unlock: { region: "johto", medals: 10 } },
  "ruinas-alfa":       { name: "Ruinas Alfa",      region: "johto", unlock: { region: "johto", medals: 11 } },
  "cueva-oscura":      { name: "Cueva Oscura",     region: "johto", unlock: { region: "johto", medals: 12 } },
  "monte-mortar":      { name: "Monte Mortar",     region: "johto", unlock: { region: "johto", medals: 13 } },
  "lago-colera":       { name: "Lago de la Furia", region: "johto", unlock: { region: "johto", medals: 14 } },
  "senda-helada":      { name: "Senda Helada",     region: "johto", unlock: { region: "johto", medals: 15 } },
  "torre-quemada":     { name: "Torre Quemada",    region: "johto", unlock: { region: "johto", medals: 16 } },
  "torre-campana":     { name: "Torre Campana",    region: "johto", unlock: { region: "johto", medals: 16 } },
  "islas-remolino":    { name: "Islas Remolino",   region: "johto", unlock: { region: "johto", medals: 16 } },

  "bosque-encinar":    { name: "Bosque Encinar",   region: "johto", unlock: { region: "johto" } },
  "torre-hojalata":    { name: "Torre Hojalata",   region: "johto", unlock: { region: "johto" } },
  "catarata-tohjo":    { name: "Catarata Tohjo",   region: "johto", unlock: { region: "johto", medals: 16 } },
  "guarida-dragon":    { name: "Guarida Dragón",   region: "johto", unlock: { region: "johto", medals: 16 } },
  "monte-plateado":    { name: "Monte Plateado",   region: "kanto", unlock: { champion: true } },
  "cueva-diglett":     { name: "Cueva Diglett",    region: "kanto", unlock: { medals: 2 } },
  "rutas-kanto-sur":   { name: "Rutas del sur de Kanto",  region: "kanto", unlock: { medals: 0 } },
  "rutas-kanto-norte": { name: "Rutas del norte de Kanto", region: "kanto", unlock: { medals: 6 } },
  "bosque-verde":      { name: "Bosque Verde",     region: "kanto", unlock: { medals: 1 } },
  "monte-moon":        { name: "Monte Moon",       region: "kanto", unlock: { medals: 2 } },
  "tunel-roca":        { name: "Túnel Roca",       region: "kanto", unlock: { medals: 3 } },
  "guaridas":          { name: "Edificios y guaridas", region: "kanto", unlock: { medals: 4 } },
  "central-electrica": { name: "Central Eléctrica", region: "kanto", unlock: { medals: 5 } },
  "zona-safari":       { name: "Zona Safari",      region: "kanto", unlock: { medals: 6 } },
  "islas-espuma":      { name: "Islas Espuma",     region: "kanto", unlock: { medals: 7 } },
  "calle-victoria":    { name: "Calle Victoria",   region: "kanto", unlock: { medals: 8 } },
